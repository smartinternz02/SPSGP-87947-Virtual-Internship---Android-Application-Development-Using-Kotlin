...
import com.example.vicinity.util.Constants.Companion.BASE_URL
...
object NetworkModule {
    ...
    @Singleton
    @Provides
    fun placesNearbyAPI(retrofit: Retrofit): PlacesNearbyAPI {
        return retrofit.create(PlacesNearbyAPI::class.java)
    }
